// Maniaplanet engine classes documentation for 2019-11-19 18:50:52
// Generated with Openplanet 1.28.0 (v4, Public, 2025-08-16)
...
struct CGameCtnAnchoredObject : public CMwNod {
  ...
  CGameWaypointSpecialProperty* WaypointSpecialProperty;
  const MwFastBuffer<CGameCtnAnchoredObject*> NeighbourObjects;
  const MwFastBuffer<uint> NeighbourObjects_ClipIndex;
};
...
struct CGameManialinkFrame : public CGameManialinkControl {
  ...
  const MwFastBuffer<CGameManialinkControl*> SubChildsCache; // Maniascript
...
struct CGameCtnEditorDecals : public CMwNod {
  ...
  enum class CGameCtnEditorDecals::ESemanticsEnum {
    Normal = 0,
    Underwater = 1,
    Other = 2,
  };
  ...
  CPlugBitmap* Bitmap;
  CGameCtnEditorDecals::ESemanticsEnum EnumSemantics;
...
struct CGameCtnBlockInfoMobil : public CMwNod {
  ...
  const MwFastBuffer<CPlugRoadChunk*> RoadChunks;
  CPlugPath* RailPath;
  CPlugPath* TrafficPath;
  const MwFastBuffer<CPlugSolid*> TextureModifiedSolidsCache;
...
struct CGamePlaygroundUIConfigMgrScript : public CMwNod {
  ...
  const MwFastBuffer<CGamePlaygroundUIConfigEvent*> PendingEvents; // Maniascript
...
struct CGameEditorPluginMap : public CGameManiaApp {
  ...
  const MwFastBuffer<CGameEditorPluginMapScriptEvent*> PendingEvents; // Maniascript
  CGameCtnChallenge* const Map; // Maniascript
  const wstring MapName; // Maniascript
...
struct CGameServerScriptXmlRpc : public CMwNod {
  const MwFastBuffer<CGameServerScriptXmlRpcEvent*> PendingEvents; // Maniascript
...
struct CGameScriptChatManager : public CMwNod {
  ...
  const MwFastBuffer<CGameScriptChatEvent*> PendingEvents; // Maniascript
...
struct CGameUserProfile : public CMwNod {
  ...
  enum class CGameUserProfile::ECamName {
    None = 0,
    Default = 1,
    Free = 2,
    Spectator = 3,
  ...
  CGameUserProfile::ECamName CamName;
};
...
struct CGameMgrShieldVis : public CSceneMgrVis {
  ...
  const MwFastBuffer<CPlugShieldModel*> ShieldModels;
};
...
struct CGameCtnDecorationMaterialModifiers : public CMwNod {
  ...
  MwFastBuffer<CGameCtnDecorationTerrainModifier*> Rules_MaterialModifiers;
};
...
struct CGameMgrCamera : public CSceneMgrVis {
  ...
  MwFastBuffer<CGameCameraSystem*> CamSystems;
};
...
struct CGameEditorMesh : public CGameEditorAsset {
  ...
  const MwFastBuffer<string> MaterialNames; // Maniascript
  const MwSArray<string> MaterialPhysicsNames; // Maniascript
...
struct CGameDataFileManagerScript : public CMwNod {
  ...
  CWebServicesTaskResult_FileListScript* Media_GetFilteredGameList(CGameDataFileManagerScript::EMediaType Type, uint Scope, wstring Path, bool Flatten); // Maniascript
...
struct CWebServicesTaskResult_MapRecordListScript : public CWebServicesTaskResult_PlayerMapRecords {
  const MwFastBuffer<CGamePlayerMapRecordScript*> MapRecordList; // Maniascript
};
...
struct CPlugSurface : public CPlug {
  ...
  MwFastBuffer<CPlugMaterial*> m_Materials;
  CPlugSkel* m_Skel;
...
struct CPlugAnimFile : public CMwNod {
  ...
  MwFastBuffer<CPlugSkel*> Skels;
  MwFastBuffer<CPlugAnimSkelBaked*> BakedClips;
  MwFastBuffer<CPlugAnimSkelJointGroup*> JointGroups;
  ...
  MwFastBuffer<CPlugAnimSkelEdition*> EditionClips;
  MwFastBuffer<CPlugAnimClip*> Clips;
  MwFastBuffer<CPlugAnimGraph*> Graphs;
  MwFastBuffer<CPlugAnimGraphStack*> GraphStacks;
...
struct CPlugParticleEmitterSubModel : public CMwNod {
  ...
  enum class CPlugParticleEmitterSubModel::EMeshInstanceType {
    Color_Iso4 = 0,
    VolumeExplosion = 1,
  };
...
struct CPlugSkel : public CMwNod {
  ...
  MwFastBuffer<uint8> AnimJointLodIndexs;
  MwFastBuffer<uint8> AnimJointFixedTranss;
  MwFastBuffer<uint16> JointChildIndexs;
  MwFastBuffer<uint16> JointChildArrays;
  bool DevNonOrtho;
  CPlugSkelSetup* Setup;
  MwStridedArray<vec3> RefLocalJointsTranss;
  MwFastBuffer<SPlugSkelSocket> Sockets;
  MwFastBuffer<SPlugSkelJointExpr> JointExprs;
  MwFastBuffer<SPlugSkelJointExprCache> CacheJointExprs;
};
...
struct CPlugImportMeshParam : public CMwNod {
  ...
  MwFastBuffer<SPlugSkelJointExpr> SkelJointExprs;
};
...
struct CPlugAdnPart : public CMwNod {
  ...
  CPlugSolid2Model* Mesh;
  MwFastBuffer<SPlugAdnTag> RequiredTags;
  MwFastBuffer<SPlugAdnTag> Tags;
...
struct CPlugAnimPoseGrid : public CMwNod {
  ...
  MwFastBuffer<GmTransQuat> JointOffsets;
  MwId RefPoseName;
...
struct CPlugAdnProject : public CMwNod {
  ...
  MwFastBuffer<STagFromName> TagsFromNames;
...
struct CPlugAdnRandomGen : public CMwNod {
  ...
  uint cDispModel;
  MwFastBuffer<SPlugAdnTag> RequiredTags;
  MwFastBuffer<SPlugAdnTag> ExcludedTags;
};
...
struct CPlugAnimImport : public CMwNod {
  ...
  MwFastBuffer<SRigImportParams> Rigs;
  void ClipsDisableAll();
  MwFastBuffer<SClipImportParams> Clips;
};
...
struct CPlugAdnRandomGroup : public CMwNod {
  ...
  string Name;
  MwFastBuffer<SPlugAdnTag> Tags;
  MwFastBuffer<CPlugMetaData*> RandomMetaDatas;
};
...
struct CSceneLayout : public CMwNod {
  ...
  MwFastBuffer<CSceneObject*> Objects;
...
struct CSceneMgrAnim : public CMwNod {
  ...
  NSceneAnim::EHandIKMode Params_HandIKParams_Mode;
  ...
  NSceneAnim::EAnimPartialMode Params_PartialAnimParams_Mode;
  NSceneAnim::EPartialAnimBlendFunc Params_PartialAnimParams_BlendFunc;
  MwFastBuffer<SBinding*> Bindings;
};
...
struct CSceneMgrWeather : public CMwNod {
  ...
  enum class CSceneMgrWeather::EClearMode {
    Fixed = 0,
    Fog = 1,
  };
  CSceneMgrWeather::EClearMode ClearMode;
  vec3 ClearColor;
  float SunIntensity;
  float MoonIntensity;
  bool EnableUpdate;
...
struct CNetMasterServer : public CMwNod {
  ...
  const MwFastBuffer<CNetHttpClient*> HttpClientCache;
...
struct CNetScriptHttpManager : public CMwNod {
  ...
  const MwFastBuffer<CNetScriptHttpEvent*> PendingEvents; // Maniascript
...
struct CTrackManiaPlayer : public CGamePlayer {
  ...
  const CTrackManiaPlayer::ERaceState RaceState;
...
struct CTmRaceInterfaceManialinkScripHandler : public CGameScriptHandlerPlaygroundInterface {
  ...
  const MwFastBuffer<CTrackManiaScriptPlayer*> Players; // Maniascript
  const MwFastBuffer<CTmRaceRulesScore*> Scores; // Maniascript
...
struct CTrackManiaScriptPlayer : public CGameScriptPlayer {
  enum class CTrackManiaScriptPlayer::ERaceState {
    BeforeStart = 0,
    Running = 1,
    Finished = 2,
    Eliminated = 3,
  };
  enum class CTrackManiaScriptPlayer::ETmRacePlayerCoopMode {
    None = 0,
    Symbiosys = 1,
    Checkpoint = 2,
  };
  enum class CTrackManiaScriptPlayer::ETmJumpMode {
    Disabled = 0,
    Simple = 1,
    Double = 2,
    Infinite = 3,
  };
  enum class CTrackManiaScriptPlayer::ETmBonusModeEventType {
    None = 0,
    Bumps = 1,
    LowGravity = 2,
    FreeWheeling = 3,
  ...
  enum class CTrackManiaScriptPlayer::ESceneVehiclePhyStuntFigure {
    None = 0,
    StraightJump = 1,
    Flip = 2,
    BackFlip = 3,
  ...
  const int CurrentClan; // Maniascript
  const CTrackManiaScriptPlayer::ERaceState RaceState; // Maniascript
  ...
  const CTrackManiaScriptPlayer::ETmRacePlayerCoopMode CoopMode; // Maniascript
  ...
  const bool MaxiAirControl; // Maniascript
  const bool EnableEmptyCars; // Maniascript
  const CTrackManiaScriptPlayer::ETmJumpMode JumpMode; // Maniascript
  const bool TinyCar; // Maniascript
  const bool EnableCatchUpSpeed; // Maniascript
  const bool EnableStuntMode; // Maniascript
  const bool EnableOnlineMode; // Maniascript
  ...
  const CTrackManiaScriptPlayer::ESceneVehiclePhyStuntFigure StuntLast; // Maniascript
  ...
  const CTrackManiaScriptPlayer::ETmBonusModeEventType BonusModeEventType; // Maniascript
...
struct CSmActionInstance : public CGameAction {
  ...
  void SendRulesEvent2(wstring Param1, MwFastBuffer<wstring>& Param2, CSmScriptPlayer* Shooter, CSmScriptPlayer* Victim, CSmObject* Object); // Maniascript
  void SendRulesEvent3(wstring Param1, MwFastBuffer<wstring>& Param2, CSmScriptPlayer* Shooter, CSmScriptPlayer* Victim, CSmObject* Object, CGameScriptTurret* Turret); // Maniascript
  void SendRulesEvent_Vehicle(wstring Param1, MwFastBuffer<wstring>& Param2, CSmScriptPlayer* Shooter, CGameScriptVehicle* Victim); // Maniascript
...
struct CSmArenaRulesMode : public CGamePlaygroundScript {
  ...
  void ActionSetVariant(CSmScriptPlayer* Player, CSmArenaRulesMode::EActionSlot ActionSlot, uint ActionVariant); // Maniascript
...
struct CGameItemModel : public CGameCtnCollector {
  ...
  enum class CGameItemModel::EnumItemClipType {
    Not_a_clip = 0, // Not a clip
    Complex = 1,
    Rectangular = 2,
    Triangular = 3,
    Square = 4,
...
struct CGameModulePlaygroundPlayerStateModel : public CGameModulePlaygroundModel {
  ...
  MwFastBuffer<CGameModulePlaygroundPlayerStateComponentModel*> Components;
...
struct SOcean {
  ...
  MwFastBuffer<SOceanWaveUI> WaveUIs;
};
...
struct SGraphInstance {
  ...
  SGraphState* StateInstance;
  float StateWeight;
  CPlugAnimGraphState* PrevStateModel;
  SGraphState* PrevStateInstance;
...
enum class EPlugAnimTransitionType {
  None = 0,
  Frozen = 1,
  Smooth = 2,
};

enum class EPlugAnimTransitionCurve {
  HardHard = 0,
  HardSoft = 1,
  SoftSoft = 2,
  SoftHard = 3,
...
enum class NSceneAnim::EHandIKMode {
  _00 = 0,
  _01 = 1,
  _02 = 2,
};

enum class NSceneAnim::EAnimPartialMode {
  _00 = 0,
  _01 = 1,
  _02 = 2,
};

enum class NSceneAnim::EPartialAnimBlendFunc {
  _00 = 0,
  _01 = 1,
  _02 = 2,
  _03 = 3,
...
enum class EPlugSkelJointExprType {
  LocalBindPose = 0,
  BlendRot = 1,
};
